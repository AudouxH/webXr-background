...
function XRManager({
  ...
  return /* @__PURE__ */ React__namespace.createElement(Interactions.InteractionManager, null, /* @__PURE__ */ React__namespace.createElement("primitive", {
    ...
    object: camera
  }), controllers.map((controller, i) => /* @__PURE__ */ React__namespace.createElement("primitive", {
    key: i,
    object: controller
  }))), children);
}
...
const XRButton = React__namespace.forwardRef(function XRButton2({ mode, sessionInit, enterOnly = false, exitOnly = false, onClick, children, ...props }, ref) {
...
const VRButton = React__namespace.forwardRef(
  ({ sessionInit = { optionalFeatures: ["local-floor", "bounded-floor", "hand-tracking", "layers"] }, children, ...rest }, ref) => /* @__PURE__ */ React__namespace.createElement(XRButton, {
    ...rest,
    ref,
    mode: "VR",
    style: buttonStyles,
